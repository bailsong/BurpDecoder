...
public class Add_Cryptor_JDialog extends JDialog {
	...
	public Add_Cryptor_JDialog(Crypto para_Crypto) {
		...
		int Cryptor_List_index = Common.Common.get_First_Index_String(this.Cryptor_List, para_Crypto.self_Type);
		if(Cryptor_List_index == -1) {
			this.dispose();
		}
		
		int Data_Format_index = Common.Common.get_First_Index_String(this.Data_Format_List, para_Crypto.Data_Format);
		...
		this.Cryptor_List_Box.setSelectedIndex(Cryptor_List_index);
		this.DataFormat_Select_CBX.setSelectedIndex(Data_Format_index);
	...
	public void Submit_Cryptor() {
		this.self_Crypto.set_Data_Format(this.DataFormat_Select_CBX.getSelectedItem().toString());
		this.self_Crypto.set_Data_Position(this.Data_Position_TXT.getText());
